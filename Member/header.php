			...
			<div class="container-fluid">
					...
					<div class="navbar-inner">
						...
						<ul class="nav">
							...
							<li>
								...
								<a data-toggle="dropdown" class="dropdown-toggle" href="">Church
								...
								<ul class="dropdown-menu">
									...
									<li><a href="index.html">Time Managements</a></li>

									<li><a href="index.html">Reports</a></li>

									<li><a href="index.html">Dashboard</a></li>

									<li><a href="index.html">Addresses and contacts</a></li>
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="from"><?php echo $firstname; ?></span>
					...
					<li class="dropdown user">
						...
						<img alt="" src="media/image/profile/<?php if($Face_picture){echo $Face_picture ; }else { ?>avatar2.png <?php } ?>" style="height:30px" />

						<span class="username"><?php echo $firstname ; ?> <?php echo $lastname ; ?></span>
