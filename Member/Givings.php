						...
						<div class="row-fluid">
							<div class="span12">
								...
								<ul class="breadcrumb">
									...
									<li>
										<a href="Givings.php">My Givings</a>
							...
							<div class="span12">
								...
								<div class="portlet box yellow">
									<div class="portlet-title">
										<div class="caption"><i class="icon-coffee"></i>Your Transactions</div>
										<div class="tools">
