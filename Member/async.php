...
if (isset($image['output']['data'])) {
    ...
    $output = Slim::saveFile($data, $name, 'media/image/profile/');
...
if (isset($image['input']['data'])) {
  ...
  $data = $image['input']['data'];
    ...
    $input = Slim::saveFile($data, $name,'media/image/profile/');
	$nameofFile=$input['name'];
	
}

 $memberID=$image['meta']->memberid;
   
 
updateimage($nameofFile,$memberID);
