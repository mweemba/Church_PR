		...
		<form  action="" method="POST">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="gc_causes_single_forms">
					<input type="password" id="password1" name="password1" placeholder="Password"><i class="fa fa-user"></i>
				</div>
			</div>
			
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="gc_causes_single_forms gc_causes_single_forms2">
					<input type="password" id="password2" name="password2" placeholder="Re Enter Password"><i class="fa fa-lock"></i>
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="gc_causes_single_form_btn gc_contact_section_main_btn col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<ul>
						<input type="Submit" class="gc_btn" name="newpassbtn" placeholder="Login" value="Login">
					</ul>
				</div>
...
$encrypt = password_hash($password1 , PASSWORD_BCRYPT, $options);
			if($password1==$password2){
				$changepass="UPDATE `users` SET `password`='$encrypt' WHERE `email`='$email'";
				$res=mysqli_query($conn,$changepass);
				if($res){
					echo "<span class='alert alert-success'>Your password has been succefully changed</span>";
				}else{
