			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="gc_footer_social_icon_wrapper">
					<div class="gc_footer_social_icon">
						<ul>
							<li><a href="facebook.com/KamwalaSDA"><i class="fa fa-facebook-square"></i> Facebook</a></li>
							<li><a href="twitter.com"><i class="fa fa-twitter-square"></i> Twitter</a></li>
							<li><a href="google.com"><i class="fa fa-google-plus-square"> Google Plus</i></a></li>
							<li><a href="#"><i class="fa fa-pinterest-square"></i> Pintrest</a></li>
							<li><a href="instagram.com"><i class="fa fa-instagram"> Instagram</i></a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="gc_footer_ul_main_wrapper">
						<div class="gc_footer_ul_wrapper">
							<ul>
								...
								<li><i class="fa fa-hand-o-right"></i> <a href="#">Give online</a></li>
...
<script type="text/javascript" src="scripts/login_confirm.js"></script>
<!--main js file end-->
<script>
	function initMap() {
