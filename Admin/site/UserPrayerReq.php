		...
		<div class="row">
			...
			<?php }?>
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="gc_blog_index_post_wrapper">
							<div class="gc_blog_index_date_main_sec gc_blog_single_index_date_cont_wrapper">
							 <a href="SendPrayerReq.php" class="gc_btn">+New Request</a><Br><Br><Br>
								<h3> MY Prayer Requests</h3>
								
								<div class="gc_causes_single_teatarea">
					
					<div class="gc_causes_select_box">
						<select name="year" id="Year" onchange='userprayer()'>
				...
				<div class="gc_causes_single_teatarea">
					...
					<div class="gc_causes_select_box">
						<select name="Month" id="Month" onchange="userprayer()">
