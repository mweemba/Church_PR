		...
		<form  action="forgotPassword.php" method="POST">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="gc_causes_single_forms">
					<input type="text" id="email" name="email" placeholder="Email"><i class="fa fa-user"></i>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="gc_causes_single_forms">
					<ul>
						<input type="Submit" class="gc_btn" name="sendcode"  value="Send">
					</ul>
				</div>
				
				
			</div>
			<?php if($_POST['sendcode']){
	        $email=$_POST['email'];
...
if(mail($to,$subject,$txt,$headers))
{
  ...
  echo '<script>window.location = "confirmpin.php";</script>';
  		}else{
