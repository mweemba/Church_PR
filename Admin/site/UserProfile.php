			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="gc_about_cont_wrapper gc_about_count_cont_wrapper">
					...
					<div class="gc_about_icons_cont_wrapper about_count_cont_heading">
						<h3><a href="UserDetails.php">Member Details</a></h3>
					</div>
					
				</div>
				<div class="gc_about_bottom_cont_wrapper">
					<p>See Your membership details and Make Changes.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="gc_about_cont_wrapper gc_about_count_cont_wrapper">
					...
					<div class="gc_about_icons_cont_wrapper about_count_cont_heading">
						<h3><a href="UserFinances.php">Finances/Stewardship</a></h3>
					</div>
				</div>
				<div class="gc_about_bottom_cont_wrapper">
					<p>See Your past Your Donations , make Donations  and Much more.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="gc_about_cont_wrapper gc_about_count_cont_wrapper">
					...
					<div class="gc_about_icons_cont_wrapper about_count_cont_heading">
						<h3><a href="UserEvents.php">Events</a></h3>
					</div>
				</div>
				<div class="gc_about_bottom_cont_wrapper">
					<p>See upcomming events by Months and Year. You are welcome to attend . we will be glad to see you</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="gc_about_cont_wrapper gc_about_count_cont_wrapper">
					...
					<div class="gc_about_icons_cont_wrapper about_count_cont_heading">
						<h3><a href="#">Church Bulletins</a></h3>
					</div>
				</div>
				<div class="gc_about_bottom_cont_wrapper">
					<p>Get a weekly Church bulletin.. subscribe to recieve weekly Email.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="gc_about_cont_wrapper gc_about_count_cont_wrapper">
					<div class="gc_about_icons_wrapper">
						<i class="fa fa-thanx"></i>
					</div>
					<div class="gc_about_icons_cont_wrapper about_count_cont_heading">
						<h3><a href="UserPrayerReq.php">Prayer Requests</a></h3>
					</div>
				</div>
				<div class="gc_about_bottom_cont_wrapper">
					<p>Make your Prayer request, 
view staus of your requests and give your Textimony.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="gc_about_cont_wrapper gc_about_count_cont_wrapper">
				...
				<div class="gc_about_bottom_cont_wrapper">
					<p>Listen and watch life Saving sermons from Or Church, .</p>
				</div>
			</div>
		</div>
	</div>
