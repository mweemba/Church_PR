		...
		<form onsubmit="return false" id="loginform">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="gc_causes_single_forms">
					<input type="text" id="username" name="username" placeholder="Username Or Email"><i class="fa fa-user"></i>
				</div>
			</div>
			
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="gc_causes_single_forms gc_causes_single_forms2">
					<input type="password" id="password1" name="password1" placeholder="Password"><i class="fa fa-lock"></i>
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="gc_causes_single_form_btn gc_contact_section_main_btn col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<ul>
						<input type="Submit" class="gc_btn" name="loginbtn" placeholder="Login" value="Login">
					</ul>
				</div>
				<div class="gc_causes_single_form_btn gc_contact_section_main_btn col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<ul>
						<a href="forgotPassword.php"><font color="blue">Forgot password?</font></a>
					</ul>
				</div>
				<div class="gc_causes_single_form_btn gc_contact_section_main_btn col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<ul>
						<a href="JoinUs.php"><font color="blue">Register</font></a>
					</ul>
				</div>
			</div>
