			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="gc_about_sec_heading_wrapper">
					<div class="gc_about_sec_heading">
						...
						<h1>Welcome to your Youth Ministries </h1>
					</div>
				</div>
			</div>
...
<div class="gc_about_counter_category_main_wrapper">
	<div class="container">
		<div class="row">
			<p>Objectives</p>
			<ol>
				<li>&nbsp; To activate the Youths so as to encourage Spiritual 
				growth </li>
				<li>To provide a Forum for promotion of Spiritual Gifts and Talents
				</li>
				<li>&nbsp;To empower the Youths to a life of service to God and to The Community
				</li>
				<li>&nbsp;To create awareness of Health Matters and appreciation of Nature among Youths
				</li>
				<li>&nbsp;To prepare the Youths for the Soon Coming of Jesus Christ
				</li>
				<li>&nbsp;To integrate the Youths in all aspects of Church activities
				</li>
			</ol>
