								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label " for="form-field-1"> Start Date </label>
															<div class="col-sm-9">
																	<input class="form-control date-picker" name="joinDate" id="startday" required="" type="text" data-date-format="dd-mm-yyyy"></div>
									</div>
                                     <div class="form-group">
										<label class="col-sm-3 control-label " for="form-field-2"> End Date </label>

										<div class="col-sm-9">
																	<input class="form-control date-picker" name="joinDate" id="endday" required="" type="text" data-date-format="dd-mm-yyyy"></div>
									</div>
