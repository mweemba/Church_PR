							...
							<h1>
								Budgets Analysis
									...
									<div class="form-group" style="text-align: center;">
										...
										<div class="col-sm-4">
											<select class="chosen-select form-control" name="yearSearch" id="budget_year" >
...
$Year='';
 ...
 <!-- Modal -->
	...
	include 'do_budget_analysis_all.php';
...
get_dept_analysis($row['Id'],$Year,$row['Name']);
