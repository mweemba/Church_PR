								 ...
								 <div class="form-group">
									...
									<div class="clearfix form-actions col-md-12">
										<div class="col-md-offset-3 col-md-6">
											<input  class="btn btn-info" type="submit" name="generate" value="Search Service">
									...
									<div class="hr hr-24"></div>
										...
										<?php if(defined('worship_meetings'.'can_add')){ ?>
                                                 <a href="add_Sermon.php"><button type="button" class="btn btn-info btn-sm">
															<i class="ace-icon fa fa-plus bigger-110"></i>New Service
														</button></a>
													<?php } ?>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
                                           ...
                                           $select="SELECT * FROM `sermons`";
  
													  $where = "WHERE TRUE";
													  
													 
													   if($Title){
													$where .= " AND `sermons`.`Tittle` LIKE :Title";
													}
													if($meeting_date){
													$where .= " AND `sermons`.`Date_Preached` =:meeting_date";
													}
													if($speaker){
													$where .= " AND `sermons`.`Preacher` LIKE :speaker";
													}
													
													if($Venue){
													$where .= " AND `sermons`.`Venue` LIKE :venue";
													}
											...
											?>
													<tr>
														...
														<td>
														<?php echo $row['Sermon_Id'];?>
														</td>
														<td><?php echo $row['Tittle'];?></td>
														<td >Date:<?php echo $row['Date_Preached'];?> Time: <?php echo $row['service_time'];?></td>
														<td><?php echo $row['Venue'];?> </td>
                                                         
														<td>
															<?php echo $row['Preacher'];?>
														</td>
<td>
														<?php echo $row['KeyText'];?>
														</td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<?php if(defined('worship_meetings'.'can_edit')){ ?>
																<a class="blue"  href="EditSermon.php?Sermon_id=<?php echo $row['Sermon_Id']?>">
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>
																</a>
																<?php } if(defined('worship_meetings'.'can_edit')){ ?>

																<a class="green"  href="EditSermon.php?Sermon_id=<?php echo $row['Sermon_Id']?>" >
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																<?php } if(defined('worship_meetings'.'can_delete')){ ?>

																<a  onclick="return confirm('Are You sure you want to delete this item')" class="red" href="Worship_service.php?Sermon_id=<?php echo $row['Sermon_Id']?>&del=yes">
