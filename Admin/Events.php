						...
						<div class="row">
                                 ...
                                 <div class="form-group">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<?php if(defined('time_managagment'.'can_add')){ ?>
											<button onclick="addTimeManage()" class="btn btn-info" type="button">
												<i class="ace-icon fa fa-check bigger-110"></i>
												Add Time Managment
											</button>
                                            <?php } if(defined('time_managagment'.'can_view')){ ?>
											&nbsp; &nbsp; &nbsp;
											<button class="btn" onclick="SearchEvents()"  type="button">
                          ...
                          <div id="responseID"></div>
									...
									<div class="col-xs-6">
										...
										<div class="col-md-offset-3 col-md-9">
											<?php if(defined('time_managagment'.'can_add')){ ?>
											 <a href="add_Event_item.php"><button class="btn btn-info" type="button">
