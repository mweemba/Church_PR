...
<div class="page-header">
						...
						<div class="row">
							<div class="col-sm-12">
								<?php 
											 $userqry="SELECT * FROM `Leaders` INNER JOIN `churchmember` on `churchmember`.`ID Number`=`Leaders`.`Member_Id` INNER JOIN `department` on `department`.`Id`=`Leaders`.`Department_id` WHERE `Position_id`='$Position_id'";
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="#" method="POST" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" placeholder=""  class="col-xs-10 col-sm-5" value='<?php echo $row['Pos_Name'];?>'   name="pos_name" required >
										...
										<div class="col-sm-9">
											...
											$q1="SELECT `Id`, `Name`, `Church`, `Dept_Description` FROM `department`";
									...
									<div class="form-group">
															...
															<select rows="10"  name="member_id" class="chosen-select col-xs-10 col-sm-5"  data-placeholder="search a member...">
																<option value="<?php echo $row['ID Number']; ?>"><?php echo $row['Last Name'];?> <?php echo $row['Last Name'];?></option>
																<?php 
											$userqry="SELECT * FROM `churchmember`";
											$results=mysqli_query($conn,$userqry);
											
											while($row8=mysqli_fetch_array($results)){ ?>
												<option value="<?php echo $row8['ID Number']; ?>"><?php echo $row8['Last Name']; ?> <?php echo $row8['Mid Name']; ?> <?php echo $row8['First Name']; ?></option>
...
<?php 
 ...
 $SQL3 = "UPDATE `leaders` SET `Pos_Name`='$Pos_name',`Member_Id`='$member',`Department_id`='$dept',`Year`='$Year',`PosStatus`='$Pos_status',`Board_member`='$board' WHERE `Position_id`='$Position_id'";
