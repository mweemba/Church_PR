							...
							<div class="col-xs-12">
								...
								<div class="clearfix">
									<div class="pull-left alert alert-success no-margin alert-dismissable">
										...
										Welcome to your profile <?php echo $firstname; ?> ...
									</div>
													...
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="<?php echo '../'.$Face_picture ?>" />
															</span>
														...
														<div class="col-xs-12 col-sm-9">
															<h4 class="blue">
																<span class="middle"><?php echo $firstname; ?> <?php echo $lastname; ?></span>
								...
								$query="SELECT * FROM `user_logs` INNER JOIN  `users` ON `user_logs`.`username`= `users`.`username` WHERE  `user_logs`.`username`='$username'";
									  ...
									  $q1=mysqli_query($conn,$query)or die(mysqli_error());
												...
												?>
															...
															<div>
																<div class="col-sm-4">
																	...
																	<img class="pull-left" alt="Alex Doe's avatar" src="<?php echo '../'.$Face_picture ?>" />
																	<a class="user" href="#"> <?php echo $row4['username'];  ?> </a>
																	<?php echo $row4['activity Detals'];  ?>.
																	</div>
											...
											?>
													...
													<div class="center">
														<button type="button" class="btn btn-sm btn-primary btn-orange btn-round">
															<i class="blue ace-icon fa fa-pencil bigger-120 orange2"></i>
